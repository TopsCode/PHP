  ...
  <div id="out_search">
           ...
           <div class="header">
		        <div class="header-top">
			        <div class="container">
						<div class="logo">
							<a href="almainpage.php"><h1>Ask Me Solution</h1></a>
						</div>
						<div class="search">
							<form>
								<input type="text" value="Search" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search';} else search();" name="ques" id="ques">
