...
<noscript>
   ...
   <div class="row">
    ...
    <select name="users" style="width: 40%;" class="form-control" id="" onchange="userid(this.value)">
      ...
      <div class="form-group">
      <button type="submit" class="btn btn-danger" name="submit">Show Details</button>
    <thead>
    <tr>
        <th>Query id</th>
       <th>Date</th>
    ...
    <tr>
    <?php
     $sel="select * from query_details where uid=$id";
           include('connection.php');
           $res_sel=$conn->query($sel);
           $no=1;
           while($r=$res_sel->fetch_object())   
        ...
        <td class="center">
            <a class="btn btn-info" href="update_query.php?eid=<?php echo $r->fd_id;?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger" href="delete_query.php?id=<?php echo $r->fd_id;?>">
