    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            //$('#form1').after('<img src="'+e.target.result+'" width="450" height="300"/>');
			  $("#lbl6").html('<img src="'+e.target.result+'" width="100" height="100" style="margin-left:40px"/>');
        }
	...
	<div class="single">
        ...
        <div style="width: 99%; height: 640px;">
            ...
            <div id="div1" class="login-body" style="width: 30%; height: 498px; float: left;">
                ...
                Upload Image :<br />
                <br />
                <input type="file"  name="file" id="file" Height="28px" Width="237px" onchange="uploadFile()" />
                <br />
                <br />
            ...
            <div id="div2" style="width: 49%; height: 280px; float: left;">
                <center style="height: 500px">
                    ...
                    <div style="width:600px; height:600px; background-image:url('<?php echo $i;?>'); background-repeat:no-repeat;">
						...
						<span id="lbl6" style="position: absolute;
    margin-top: 19%;
    margin-left: -93px;
    width: 100px;
    height: 100px;">
