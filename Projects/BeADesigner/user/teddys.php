	...
	<div class="products">	 
		<div class="container">
			...
			<?php
					...
					{
				?>
				<div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".5s" height="300">
					<div class="new-top">
						<a href="single.html"><img src="image/<?php echo $c->image;?> class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
					...
					<div class="new-bottom">
						<h5><a class="name" href="single.html"><?php echo $c->product_name ;?> </a></h5>
