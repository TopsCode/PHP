				...
				<div class="col-md-6 single-top wow fadeInLeft animated" data-wow-delay=".5s">	
					<div class="flexslider">
						<ul class="slides">
							...
							<li data-thumb=<img src="image/<?php echo $c->image;?>" height="250" width="230" alt="" />>
								<div class="thumb-image"> <h1>Hello</h1> data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
