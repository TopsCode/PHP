...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2017 at 07:12 AM
...
(4, 'Pilo', 'p4.jpg', 400, 1),
(5, 'Tshirt', 'tshirt1.jpg', 350, 2),
(6, 'Photo frame', 'phframe1.jpg', 350, 4),
(7, 'Mug', 'images (3).jpg', 350, 3);
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
--
