	...
	<div class="products">	 
		<div class="container">
			...
			<div class="col-md-9 product-model-sec">
				...
				?>
				<div class="col-md-9 new-grid simpleCart_shelfItem wow flipInY animated" data-wow-delay=".5s">
					<div class="new-top">
						<a href="single.html"><img src="image/<?php echo $p->image;?>" height="250" width="230" alt=""/></a>
						<div class="new-text">
							<ul>
					...
					<div class="new-bottom">
						<h5><a class="name" href="single.html"><?php echo $p->product_name ;?> </a></h5>
