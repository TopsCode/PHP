<?php 
include 'include/returnpro_controller.php'; 
error_reporting (0);
session_start();
...
<html>
<head>
<title>Bespoke :: Return Product</title>
<!-- for-mobile-apps -->
...
<body>
	...
	<div class="cart-items">
		...
		<?php 
			...
			{
			?>
			<h3 class="wow fadeInUp animated" data-wow-delay=".5s">Customer::<?php echo $_SESSION['user'];?></h3>
			...
			<div class="cart-header wow fadeInUp animated" data-wow-delay=".5s">
				<div class="alert-close"> <a href="cart.php?remove_cartid=<?php echo $o->order_id?>" class="btn btn-danger">Return</a> </div>
				...
				<div class="cart-sec simpleCart_shelfItem">
					...
					<div class="cart-item-info">
						...
						<ul class="qty">
							<li><p>Price :<?php echo $t=$p*$q;?></p></li>
			...
			<?php 
				  ...
				  <div class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".7s" style="">
					<h4><a href="#">Grand Total : <b>&#8377; <?php echo $total=$total;?>.00</b> </a><br/><br/>
       ...
       <br/> <input type="image" name="submit" border="0"
        ...
        <img alt="" border="0" width="1" height="1" src="image/pixel.gif" ><br/><br/>
		<a href="shippinginfo.php"><button type="submit" name="proceedtopayment" class="btn btn-info" value=""> Proceed to Payment</button></a>
