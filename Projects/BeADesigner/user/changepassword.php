...
<body>
	...
	<div class="login-page">
		<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
			<h3 class="title">Change Password<span> Form</span></h3>
			<p></p>
		</div>
		<div class="widget-shadow">
			<div class="login-top wow fadeInUp animated" data-wow-delay=".7s">
				<h4>Welcome Bespoke Design ! <br>  <a href="register.php"> Change Password »</a> </h4>
			</div>
			<div class="login-body wow fadeInUp animated" data-wow-delay=".7s">
				<form method="post">
					<input type="text" class="user" name="old_pass" placeholder="Enter your Old Password" required="">
					<input type="password" name="new_pass" class="lock" placeholder=" Enter youe New Password">
					<input type="password" name="con_pass" class="lock" placeholder=" Enter your Confirm Password">
