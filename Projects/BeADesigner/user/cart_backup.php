...
$paypal_id = 'jaygediya0@gmail.com'; //Business Email
...
<body>
	...
	<div class="cart-items">
		...
		<?php 
			...
			<?php 
				  ...
				  <div class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".7s" style="">
					<h4><a href="#">Grand Total : <b>&#8377; <?php echo $total;?>.00</b> </a><br/><br/>
        ...
        <!-- Specify URLs -->
        <input type='hidden' name='cancel_return' value='http://localhost/pets_home1/User/cancel.php'>
		<input type='hidden' name='return' value='http://localhost/pets_home1/User/success.php'>
